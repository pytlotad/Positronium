...
// gExternalMagneticField, earthScaleMagneticField (continuing the split of
...
// comment).
#include "modules/zero_point_field.hpp"
...
// isFinite(Vec3), isFinite(State), interpolateVector, interpolateDipole,
// interpolateState (Stage 0 of splitting engine/experiments/ROOT
// presentation apart -- see the header's own comment).
...
// presentation apart -- see the header's own comment for what this depends
...
#include "modules/legendre_anisotropy_fit.hpp"
...
// engine/experiments/ROOT presentation apart -- see the header's own
// comment).
#include "modules/text_formatting.hpp"
...
// own comment).
#include "modules/plot_style.hpp"

// GaussianFitSummary, gaussianMaximumLikelihood (continuing the split of
// engine/experiments/ROOT presentation apart -- see the header's own
// comment).
#include "modules/gaussian_fit.hpp"

// SurvivalObservation, KaplanMeierPoint, KaplanMeierEstimate, kaplanMeier
// (continuing the split of engine/experiments/ROOT presentation apart --
// see the header's own comment).
#include "modules/kaplan_meier.hpp"

// compactNumber, AnalysisLine, drawAnalysisBox, gaussianMleOverlay,
// reportExports, reportArchiveOperation (continuing the split of engine/
// experiments/ROOT presentation apart -- see the header's own comment).
